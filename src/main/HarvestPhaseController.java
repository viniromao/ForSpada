...
public class HarvestPhaseController {
	...
	public void startHaverstPhase(List<Creature> creatures, Field field, Warehouse warehouse) {
		System.out.println("harvest phase starting...");
		while(true) {
